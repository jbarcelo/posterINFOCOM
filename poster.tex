...
\path
	\ifpdf
		(0,0) node{\includegraphics[width=\linewidth]{csma_ca-eps-converted-to.pdf}}
	\else
		(0,0) node{\includegraphics[width=\linewidth]{csma_ca.eps}}
	\fi
	(0,-1.3) node {\smaller Example CSMA/CA behavior ($CW_{\min}=16$).};
\end{tikzpicture}
\end{center}
...
\path
	\ifpdf
		(0,0) node{\includegraphics[width=\linewidth]{ECA-vs-CA-FINAL-eps-converted-to.pdf}}
	\else
		(0,0) node{\includegraphics[width=\linewidth]{ECA-vs-CA-FINAL.eps}}
	\fi
	(0,-4.29) node {\smaller Throughput and fairness in CSMA/CA and Basic CSMA/ECA ($CW_{\min}=32$).};
\end{tikzpicture}
\end{center}
