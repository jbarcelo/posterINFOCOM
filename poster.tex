...
\headerbox{Motivation}{name=dcf,column=0,row=0,span=2}
{
...
\headerbox{Using a deterministic backoff}{name=deterministic,column=0,below=throughput}{
...
\headerbox{Test}{name=test,column=0,below=deterministic,span=1,above=bottom}{
